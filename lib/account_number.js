export class AccountNumber {
	...
	digit(index){
		return Number(this.accountNumberArray[index])
	}
	...
	get readable() {
		return !this.accountNumberArray.some(digit => (digit === '?'))
	}
	...
	toString() {
		let separator = '	'
		return (this.accountNumberArray.join('') + separator + this.status).trim()
	}
